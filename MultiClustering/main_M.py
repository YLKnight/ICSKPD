...
from MultiClustering.ImageClustering_M import ImageClustering_M
from Visualization import *
from Utils.criterion import error, Acc_pmtt
from time import time

# Pre-settings
keyParameters = {'Shape': 'circle',
                 'Sigma of Noise': 2,
                 'Samples Size': 1000}
...
theta1, theta2, theta3, diff1, diff2, Y, X_TS = Gnrt_3(n, pw, sigma_img, int_sgn, sigma_ns)
Y_num = dum2num(Y)
...
show = True
if show:
    Vis_mean_diff(theta3, diff1, diff2, pw_block, D1, d1)  # Show control and signal
    Vis_samples(X_TS[0], X_TS[n1+1], X_TS[n1+n2+1], pw-pw_block)  # Show samples
...
if show:
    Vis_detection(Union, C_hat, pw_block)
